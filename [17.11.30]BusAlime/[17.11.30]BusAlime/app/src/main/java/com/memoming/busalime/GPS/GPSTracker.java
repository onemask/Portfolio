package com.memoming.busalime.GPS;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    private static final long MIN_TIME_BW_UPDATES = 1000 * 3; //  3초
    ...
    public void onProviderDisabled(String provider) {
        ...
        mHandler.sendEmptyMessage(StationActivity.RENEW_GPS);
    ...
    private void sendString(String str){
        ...
        msg.what = StationActivity.SEND_PRINT;
